...
func TestHaltHourCharging(t *testing.T) {
	...
	periods[0] = utils.ChargePeriod{EndPeriod: 1, StartPeriod: 0, Start: "00:00", End: "01:00", Price: 1.99}
	periods[1] = utils.ChargePeriod{EndPeriod: 12, StartPeriod: 1, Start: "01:00", End: "12:00", Price: 9.90}
	periods[2] = utils.ChargePeriod{EndPeriod: 18, StartPeriod: 12, Start: "12:00", End: "18:00", Price: 10.00}
	periods[3] = utils.ChargePeriod{EndPeriod: 24, StartPeriod: 18, Start: "18:00", End: "24:00", Price: 60.00}
	price, periodAll := utils.NewHaltHourCharging(periods, day24HourPeriod).Outlay("2024-04-22 08:36", "2024-04-22 10:00")
